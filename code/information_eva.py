...
def label_attack_defend(chessboard, player):
    ...
    for r in range(10):
        for c in range(9):
            newboard[r][c] = count_defend(chessboard, player, [r, c]) - count_defend(chessboard, opp, [r, c])
...
def ext_info_eva_full(fen):
    ...
    atk_dfd_map = label_attack_defend(_chessboard, _player)
    for i in range(90):
